...
{
    public class TemplateProjectMoqTest
    {
        private Mock<ITemplateProjectService> _mockServiceProject;
        private IMapper _mapper;
        
        public TemplateProjectMoqTest()
        {
        ...
        {
            _mockServiceProject = new Mock<ITemplateProjectService>();
            _mockServiceProject.Setup(repo => repo.GetAllTemplateProject())
            .Returns(TestAllTemplateProject());

            var controller = new TemplateProjectController(_mapper, _mockServiceProject.Object);
        ...
        public async Task<List<TemplateProject>> TestAllTemplateProject()
        {
            ...
            List<TemplateProject> templates = new List<TemplateProject>();
            templates.Add(templateProject);
            return templates;
        }
    }
}
